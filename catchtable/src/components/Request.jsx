    ...
    <Fade>
      <div className={`${FlexCol} pt-12`}>
        ...
        <form className={`flex justify-center pb-12 px-20 w-full transition-height`}>
          <textarea className=' bg-transparent border-4 border-gray-300 rounded-2xl resize-none p-4 tracking-wider w-[90%] h-[280px]
                  outline-none px-4 items-start text-2xl text-white'
            type="text"
            name="request"
            value={request}
            onChange={onChange}
